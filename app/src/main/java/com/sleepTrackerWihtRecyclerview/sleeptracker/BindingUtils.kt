...
fun ImageView.setSleepImage(item: TableEntity?) {
    item?.let {
...
fun TextView.setSleepDurationFormatted(item: TableEntity?) {
    item?.let {
...
fun TextView.setSleepQualityString(item: TableEntity?) {
    item?.let {
